...
public class NPC_GenericVillagerBoy1 extends NPC_Generic {


    public NPC_GenericVillagerBoy1(MainGame mainGame, int xTile, int yTile, Zone zone) {
        this.dialog = new Dialog();
        this.animation = new ResourceLoaderEntity("npc/boy1");
        animation.load();
        this.mg = mainGame;
        this.zone = zone;
        worldX = xTile * 48;
